...
final public class Constants {
    ...
    private List<String> staticBasePaths = new ArrayList<>();
    ...
    public void setFileRenderPath(String fileRenderPath) {
        ...
        this.fileRenderPath = fileRenderPath;
    }
    ...
    public Constants addStaticBasePaths(String... basePaths) {
        for (String basePath : basePaths) {
            if (!basePath.startsWith("/")) {
                basePath = "/" + basePath;
            }
            this.staticBasePaths.add(basePath);
        }
        return this;
    }

    public boolean inHandler(String url) {
        if (!url.contains(".")) {
            return true;
        }
        if (!staticBasePaths.isEmpty()) {
            for (String basePath : staticBasePaths) {
    ...
    public void openTx(TxProvider txProvider) {
        this.tx = true;
