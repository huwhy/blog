...
public abstract class Controller {
    ...
    private Map<String, String> urlParaMap;
    ...
    void init(HttpServletRequest request, HttpServletResponse response, Map<String, String> urlParaMap) {
    ...
    public String getUrlPara(String name) {
        return urlParaMap.get(name);
    }

    public String getUrlPara(String name, String defaultValue) {
        String result = urlParaMap.get(name);
        return result != null && !"".equals(result) ? result : defaultValue;
    }
     ...
     * @return a Integer representing the single value of the parameter
     */
    public Integer getUrlParaToInt(String name) {
        return toInt(urlParaMap.get(name), null);
    }
     ...
     * @return a Integer representing the single value of the parameter
     */
    public Integer getUrlParaToInt(String name, Integer defaultValue) {
        return toInt(urlParaMap.get(name), defaultValue);
    }

    public Long getUrlParaToLong(String name) {
        return toLong(urlParaMap.get(name), null);
    }
     ...
     */
    public Date getUrlParaToDate(String key) {
        return toDate(getUrlPara(key), null);
    }
