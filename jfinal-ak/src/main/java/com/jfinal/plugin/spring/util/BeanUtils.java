...
public abstract class BeanUtils {
    ...
    public static void copyProperties(Object source, Object target, String... ignoreProperties) {
        ...
        try {
            ...
            ignoreSet.add("class");
            PropertyDescriptor[] sourcePds = CachedIntrospectionResults
                    .forClass(source.getClass()).getPropertyDescriptors();
            CachedIntrospectionResults targetResults = CachedIntrospectionResults
                    .forClass(target.getClass());
            Method readMethod;
            Method writeMethod;
            Object val;
            String name;
